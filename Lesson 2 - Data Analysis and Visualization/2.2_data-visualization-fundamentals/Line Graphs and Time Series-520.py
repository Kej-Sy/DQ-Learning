...
plt.plot(france[f"Date_reported"], france["Cumulative_cases"], label="France")
plt.plot(uk[f"Date_reported"], uk["Cumulative_cases"], label="The UK")
plt.plot(italy[f"Date_reported"], italy["Cumulative_cases"], label="Italy")
plt.legend()
plt.show()
