...
ax.axvline(0.5, ymin=0.1, ymax=0.9, color="grey", alpha=0.1, lw=1), 
ax.axvline(1.45, ymin=0.1, ymax=0.9, color="grey", alpha=0.1, lw=1)
...
ax.text(1.43, -1.7, '-0.5'+ ' '*31 + '+0.5',
        color='grey', alpha=0.5)
ax.axhline(11, color="gray", linewidth=1, alpha = 0.5, xmin=0.01, xmax=0.32)
ax.text(-0.33, 11.2, "RED WINE", weight="bold")
ax.axhline(11, color="gray", linewidth=1, alpha = 0.5, xmin=0.67, xmax=0.98)
