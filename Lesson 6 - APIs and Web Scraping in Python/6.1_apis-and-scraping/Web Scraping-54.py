...
total_plays_count = parser.select("#total-plays")[0]
patriots_total_plays = total_plays_count.select("td")[2]
patriots_total_plays_count = patriots_total_plays.text

total_yards_count = parser.select("#total-yards")[0]
seahawks_total_yards = total_yards_count.select("td")[1]
